...
describe("MNIST training", function() {
    it.skip("Should achieve over 85% success rate within 15 seconds of training with a batch size of 1 and 1 epoch", function() {
        this.timeout(15000);
    ...
    it.skip("Should achieve over 85% success rate within 30 seconds of training with a batch size of 32 and 3 epochs", function() {
        this.timeout(30000);
